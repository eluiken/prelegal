...
import { DocSchema, GenericDocValues, buildGenericCoverPage } from "@/lib/doc-schemas";

interface Props {
  schema: DocSchema;
  values: GenericDocValues;
  previewRef: React.RefObject<HTMLDivElement | null>;
}

export default function DocPreview({ schema, values, previewRef }: Props) {
  const markdown = buildGenericCoverPage(schema, values);
